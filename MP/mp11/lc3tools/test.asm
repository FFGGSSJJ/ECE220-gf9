...
;                    j           local to main   offset=-1
	...
	LDR R0,R6,#0
	ADD R1,R5,#0
	STR R0,R1,#0  ;copy value into the variable
	...
	BRnzp LBL5
LBL4 .STRINGZ "Hello!\n"
LBL5  ;other instructions
	LEA R0,LBL6
	ADD R6,R6,#-1
	STR R0,R6,#0
	BRnzp LBL7
LBL6 .STRINGZ "%d\n"
LBL7  ;other instructions
	LD R0,LBL2
	JSRR R0
	BRnzp LBL3
LBL2 .FILL PRINTF
LBL3  ;pop arg out
	...
	STR R0,R6,#0
	BRnzp LBL11
LBL10 .STRINGZ "i at %d, j at %d\n"
LBL11  ;other instructions
	LD R0,LBL8
	JSRR R0
	BRnzp LBL9
LBL8 .FILL PRINTF
LBL9  ;pop arg out
	...
	STR R0,R6,#0
	ADD R6,R6,#1 ;pop out the value
	LDR R0,R5,#0 ;load the value into R0
	ADD R6,R6,#-1
...
LBL13  ;pop arg out
	...
	STR R0,R6,#0
	ADD R6,R6,#1 ;pop out the value
	LDR R0,R5,#-1 ;load the value into R0
	ADD R6,R6,#-1
	STR R0,R6,#0  ;push variable value into stack
	LEA R0,LBL18
	ADD R6,R6,#-1
